package com.senon.leanstoragedemo.adapter;
...
//    public RecycleHolder setGlideImage(int viewId, String url, Activity activity){
//
//        ImageView image = findView(viewId);
//        Glide.with(activity)
//                .load(url)
//                .error(R.mipmap.placehodler_img)
////                .transform(new RotateTransformation(activity,android.os.Build.MANUFACTURER.
////                        equalsIgnoreCase("samsung") ? 270 : 0))
//                .placeholder(R.mipmap.placehodler_img).into(image);
//        return this;
//    }

//    public RecycleHolder setGlideGif(int viewId, String url, Activity activity){
//        ImageView image = findView(viewId);
//        Glide.with(activity).load(url).asGif().diskCacheStrategy(DiskCacheStrategy.SOURCE).error(R.mipmap.placehodler_img).
//                placeholder(R.mipmap.placehodler_img).into(image);
//        return this;
//    }
//
//    public RecycleHolder setGlideCircleImage(int viewId, String url, Activity activity){
//        ImageView image = findView(viewId);
//        Glide.with(activity).load(url).placeholder(R.drawable.portrait)
//                .error(R.drawable.portrait).transform(new GlideCircleTransform(activity)).into(image);
//        return this;
//    }
